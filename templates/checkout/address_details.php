...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <div class="center-screen" style="float: center; padding-top: 7%;">
            <div class="card" style="width: max(700px); text-align: center; z-index: 80; box-shadow: 0px 0px 7px grey;">
                <br>
                <h1 style="color: #46b35e;">Enter Shipping Address</h1>
                <br>
                <h3 style="color: red;"> <?php
                if (isset($_SESSION["address_error"])) {
                    echo $_SESSION["address_error"] . " please try again.";
                } 

                ?></h3>
                <br><br><br>
                                <!--change action to check validity of address... or just temp store for completion of transaction print-->
                <form method = "post" action= "../../routes/update_address.php" name="address_info">
                    ...
                    <br><br>
                    <input class= "inputField" style="text-indent: 10px" placeholder="State/Providence" type="text" name="state" required>
                    <br><br>
