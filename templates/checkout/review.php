...
<body>
    <div class="header">
        ...
        ?>
        <a style="float: right; padding-top: 10px; padding-right:25px;" class="cart"
    ...
    <div class="center-screen" style="padding-top: 7%;">
            ...
            <div style="display:flex; justify-content: center; align-items: center;">
                <div style="display:flex; justify-content:space-between; text-align:center;">
                    ...
                    <div style="flex-grow: 5">
                        <table>
                            <tr>
                                <th>Shipping Address <a class="noindex" href="./address_details.php">Edit</a></th>
                            </tr>
                            <?php
                            if (!$address_results) {
            ...
            <div style="display:flex; justify-content: center; align-items: center;">
                <div style="display:flex; justify-content:space-between; text-align:center;">
                    ...
                    <div style="flex-grow: 5">
                        ...
                        <table>
                            <tr>
                                <th>Payment Info <a class="noindex" href="./card_details.php">Edit</a></th>
                            </tr>
        ...
        <div class="card" style="margin-left: 40px; width: max(300px); right: 3%; top: 120px; text-align: center; box-shadow: 0px 0px 7px grey">
            ...
            <div style='position: relative; border-top: 1px solid grey; padding-top: 2%;'>
                <form action="../../routes/order_action.php">
					<input
						style='border: 1px solid white; font-size: 30px; color: white; background-color: var(--dark);height: 60px; width: 280px; border-radius:3px ;position: relative; '
                        type="submit"  value="Confirm Shipment" id="submitButton">
                    </form>
			</div>
             <!-- Submit Button -->
